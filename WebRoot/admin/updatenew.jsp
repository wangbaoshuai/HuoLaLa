...
<table class="table table-bordered table-hover definewidth m10" style="margin-left:3%;margin-top:2%;">
    <tr>
        ...
        <td><input type="text" name="n.ntitle" value="${findonenew.ntitle }" style="height: 41px; width: 546px"/></td>
    ...
    <tr>
        ...
        <td><textarea style="height: 80px; width: 546px" name="n.ncontent">${findonenew.ncontent }</textarea></td>
    </tr> 
    <tr>
        <td class="tableleft">发布时间</td>
        <td style="height: 46px; "> <div style="margin:0 auto;">
	             <input type="text"  name="n.ndate" id="time1" value="${findonenew.ndate }" onClick="return Calendar('time1');" class="text_time"/>
             </div> 
        </td>
    </tr> 
    ...
    <tr>
        ...
        <td>
            <input  style="margin-left:180px;"type="submit" class="btn btn-primary" value="修改" >&nbsp;&nbsp;<button type="button" class="btn btn-primary"><a href="allnew.jsp">返回列表</a></button>
        </td>
    </tr>
</table>
</form>
